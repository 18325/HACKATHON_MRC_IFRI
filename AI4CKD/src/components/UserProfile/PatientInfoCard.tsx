...
export default function PatientInfoCard({ id }: { id: string | undefined }) {
    ...
    const updateMutation = useMutation({
        mutationFn: async (data: PatientFormData) => {
            const response = await axiosPrivate.put(`/patients/${id}`, data);
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                    <div className="col-span-2 lg:col-span-1">
                                        ...
                                        <Input
                                            type="text"
                                            {...register("last_name")}
                                            error={!!errors.last_name || !!err.last_name}
                                            hint={errors.last_name?.message || err.last_name}
                                        />
                                    </div>
                                    ...
                                    <div className="col-span-2 lg:col-span-1">
                                        ...
                                        <Input
                                            type="text"
                                            {...register("first_name")}
                                            error={!!errors.first_name || !!err.first_name}
                                            hint={errors.first_name?.message || err.first_name}
                                        />
                                    </div>
                                        ...
                                        <Controller
                                            ...
                                            render={({ field }) => (
                                                <Select
                                                    ...
                                                    error={!!errors.gender || !!err.gender}
                                                    hint={errors.gender?.message || err.gender}
                                                />
                                            )}
                                        />
                                    </div>
                                    ...
                                    <div className="col-span-2 lg:col-span-1">
                                        ...
                                        <Input
                                            type="text"
                                            {...register("phone")}
                                            error={!!errors.phone || !!err.phone}
                                            hint={errors.phone?.message || err.phone}
                                        />
                                    </div>
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <Input
                                            type="text"
                                            {...register("address")}
                                            error={!!errors.address || !!err.address}
                                            hint={errors.address?.message || err.address}
                                        />
                                    </div>
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <Input
                                            type="email"
                                            {...register("email")}
                                            error={!!errors.email || !!err.email}
                                            hint={errors.email?.message || err.email}
                                        />
                                    </div>
                                </div>
                            </div>
